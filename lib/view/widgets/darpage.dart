  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        var image = darshanSongList[index].metas.image?.path ?? '';
        var title = darshanSongList[index].metas.title ?? '';
        var album = darshanSongList[index].metas.album ?? '';
        var ar = darshanSongList[index];
