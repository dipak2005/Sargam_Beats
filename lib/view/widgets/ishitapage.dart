...
class Ishitapage extends StatefulWidget {
  const Ishitapage({super.key});

  @override
  State<Ishitapage> createState() => _IshitapageState();
}

class _IshitapageState extends State<Ishitapage> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        var image = ishItaSongList[index].metas.image?.path ?? '';
        var title = ishItaSongList[index].metas.title ?? '';
        var album = ishItaSongList[index].metas.album ?? '';
        var ar = ishItaSongList[index];
