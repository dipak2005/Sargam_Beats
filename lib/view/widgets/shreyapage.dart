  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        var image = shreyaSongList[index].metas.image?.path ?? '';
        var title = shreyaSongList[index].metas.title ?? '';
        var album = shreyaSongList[index].metas.album ?? '';
        var ar = shreyaSongList[index];
