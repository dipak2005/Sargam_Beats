  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        var image = arrSongList[index].metas.image?.path ?? '';
        var title = arrSongList[index].metas.title ?? '';
        var album = arrSongList[index].metas.album ?? '';
                                ...
                                Container(
                                  ...
                                  child: StreamBuilder<Playing?>(
                                      ...
                                      builder: (context, snapshot) {
                                        var image1 = snapshot.data?.playlist
