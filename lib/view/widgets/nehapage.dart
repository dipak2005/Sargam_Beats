...
class Nehapage extends StatefulWidget {
  const Nehapage({super.key});

  @override
  State<Nehapage> createState() => _NehapageState();
}

class _NehapageState extends State<Nehapage> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        var image = nehaSongList[index].metas.image?.path ?? '';
        var title = nehaSongList[index].metas.title ?? '';
        var album = nehaSongList[index].metas.album ?? '';
        var ar = nehaSongList[index];
