...
class Tulsipage extends StatefulWidget {
  const Tulsipage({super.key});

  @override
  State<Tulsipage> createState() => _TulsipageState();
}

class _TulsipageState extends State<Tulsipage> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        var image = tuLsiSongList[index].metas.image?.path ?? '';
        var title = tuLsiSongList[index].metas.title ?? '';
        var album = tuLsiSongList[index].metas.album ?? '';
        var ar = tuLsiSongList[index];
        return Column(
